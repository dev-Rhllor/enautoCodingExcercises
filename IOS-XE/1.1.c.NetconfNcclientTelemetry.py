...
### This generates a dynamic telemetry subscription, when the session is over, the subscription is erased from the device.
### Another approach is to configure the telemetry subscription in the device and then configure a collector using telegraf to receive the telemetry.
